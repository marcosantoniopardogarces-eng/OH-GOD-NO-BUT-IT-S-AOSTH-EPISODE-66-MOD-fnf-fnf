...
IntroTagColor = '358ACF'	--Color of the tag at the end of the box.
...
function onCreate()
	...
	makeLuaSprite('JukeBoxTag', 'empty', -355-IntroTagWidth, 50)
	makeGraphic('JukeBoxTag', 300+IntroTagWidth, 100, IntroTagColor)
	setObjectCamera('JukeBoxTag', 'other')
	addLuaSprite('JukeBoxTag', true)

	--the box
	makeLuaSprite('JukeBox', 'empty', -305-IntroTagWidth, 50)
	makeGraphic('JukeBox', 300, 100, '000000')
	setObjectCamera('JukeBox', 'other')
	addLuaSprite('JukeBox', true)
	
	--the text for the "Song Sus" bit
	makeLuaText('JukeBoxText', 'AHORA JUGANDO:', 300, -305-IntroTagWidth, 65)
	...
	makeLuaText('JukeBoxSubText', songName, 300, -305-IntroTagWidth, 100)
